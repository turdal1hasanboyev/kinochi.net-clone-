    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, db_index=True, max_length=150, null=True)),
                ('last_name', models.CharField(blank=True, db_index=True, max_length=150, null=True)),
