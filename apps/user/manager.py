...
class CustomUserManager(UserManager):
    def create_user(self, email, first_name=None, last_name=None, image=None, phone_number=None, description=None, password=None, **extra_fields):
        ...
        user = self.model(email=email, first_name=first_name, last_name=last_name, image=image, phone_number=phone_number, description=description, **extra_fields)
    ...
    def create_superuser(self, email, first_name=None, last_name=None, image=None, phone_number=None, description=None, password=None, **extra_fields):
        user = self.create_user(email, first_name=first_name, last_name=last_name, image=image, phone_number=phone_number, description=description, password=password, **extra_fields)
        user.is_staff = True
